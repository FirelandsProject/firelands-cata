...
if(CMAKE_CXX_COMPILER_VERSION VERSION_LESS GCC_EXPECTED_VERSION)
  message(FATAL_ERROR "GCC: FirelandsCore requires version ${GCC_EXPECTED_VERSION} to build but found ${CMAKE_CXX_COMPILER_VERSION}")
endif()
...
if( WITH_WARNINGS )
  target_compile_options(fc-warning-interface
    INTERFACE
      -W
      -Wall
      -Wextra
...
if (BUILD_SHARED_LIBS)
  ...
  target_compile_options(fc-hidden-symbols-interface
    INTERFACE
      -fvisibility=hidden)
