...
static LOCALIZED_MPQ_INFO LocaleMpqs_WoW[] = {{"expansion1-locale-####", 18, 22}, {"expansion1-speech-####", 18, 22}, {"expansion2-locale-####", 18, 22}, {"expansion2-speech-####", 18, 22},
    {"expansion3-locale-####", 18, 22}, {"expansion3-speech-####", 18, 22}, {"locale-####", 7, 11}, {"speech-####", 7, 11}, {NULL, 0, 0}};
...
static DWORD ApplyFilePatch_COPY(TMPQPatcher* pPatcher, PMPQ_PATCH_HEADER pFullPatch, LPBYTE pbTarget, LPBYTE pbSource)
{
    // Sanity checks
...
static DWORD ApplyFilePatch_BSD0(TMPQPatcher* pPatcher, PMPQ_PATCH_HEADER pFullPatch, LPBYTE pbTarget, LPBYTE pbSource)
{
...
static DWORD ApplyFilePatch(TMPQPatcher* pPatcher, PMPQ_PATCH_HEADER pFullPatch)
{
...
static bool IsMatchingPatchFile(TMPQArchive* ha, const char* szFileName, LPBYTE pbBaseFileMd5)
{
    ...
    if (SFileOpenFileEx((HANDLE)ha, szFileName, SFILE_OPEN_FROM_MPQ, &hFile))
    {
...
static bool CheckPatchPrefix_SC2_ArchiveName(TMPQArchive* haPatch, const TCHAR* szPathPtr, const TCHAR* szSeparator, const TCHAR* szPathEnd, const TCHAR* szExpectedString, size_t cchExpectedString)
{
...
static bool FindPatchPrefix_SC2_MatchFiles(TMPQArchive* haBase, TMPQArchive* haPatch, TFileEntry* pBaseEntry)
{
    ...
    else
    {
        ...
        bResult = CreatePatchPrefix(haPatch, pPatchPrefix->szPatchPrefix, pPatchPrefix->nLength);
    }
