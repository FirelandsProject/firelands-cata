...
static bool GetDefaultPatchPrefix(const TCHAR* szBaseMpqName, char* szBuffer)
{
...
static int ApplyMpqPatch_COPY(TMPQFile* hf, TPatchHeader* pPatchHeader)
{
...
static int ApplyMpqPatch_BSD0(TMPQFile* hf, TPatchHeader* pPatchHeader)
{
...
static int ApplyMpqPatch(TMPQFile* hf, TPatchHeader* pPatchHeader)
{
    int nError = ERROR_SUCCESS;
