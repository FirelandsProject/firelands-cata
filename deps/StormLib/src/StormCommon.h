...
template <typename XCHAR, typename XINT> XCHAR* IntToString(XCHAR* szBuffer, size_t cchMaxChars, XINT nValue, size_t nDigitCount = 0)
{
...
DWORD SFileAddFile_Init(TMPQArchive* ha, const char* szArchivedName, ULONGLONG ft, DWORD dwFileSize, LCID lcFileLocale, DWORD dwFlags, TMPQFile** phf);
