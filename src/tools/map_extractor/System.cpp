...
char const* Locales[LOCALES_COUNT] = {"enGB", "enUS", "deDE", "esES", "frFR", "koKR", "zhCN", "zhTW", "enCN", "enTW", "esMX", "ruRU", "ptBR", "ptPT", "itIT"};

uint8 const MpqToWowLocale[LOCALES_COUNT] = {
    LOCALE_enUS, LOCALE_enUS, LOCALE_deDE, LOCALE_esES, LOCALE_frFR, LOCALE_koKR, LOCALE_zhCN, LOCALE_zhTW, LOCALE_zhCN, LOCALE_zhTW, LOCALE_esMX, LOCALE_ruRU, LOCALE_ptBR, LOCALE_ptBR, LOCALE_itIT};
...
void ExtractMapsFromMpq(uint32 build)
{
    ...
    for (uint32 z = 0; z < map_count; ++z)
    {
        ...
        if (FILE* tileList = fopen(Firelands::StringFormat("%s/maps/%03u.tilelist", output_path, map_ids[z].id).c_str(), "wb"))
        {
