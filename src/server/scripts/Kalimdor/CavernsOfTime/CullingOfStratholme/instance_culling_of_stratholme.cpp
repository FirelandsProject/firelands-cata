...
DoorData const doorData[] = {
    {GO_MALGANIS_GATE_2, DATA_MAL_GANIS, DOOR_TYPE_ROOM}, {GO_EXIT_GATE, DATA_MAL_GANIS, DOOR_TYPE_PASSAGE}, {0, 0, DOOR_TYPE_ROOM} // END
};
...
static const std::array<WaveLocation, WAVE_LOC_MAX - WAVE_LOC_MIN + 1> WaveLocations = {
    {{// King's Square
         WORLDSTATE_WAVE_MARKER_KS, {{{2131.474f, 1352.615f, 131.372f, 6.10960f}, {2131.463f, 1357.127f, 131.587f, 5.95173f}, {2129.795f, 1345.093f, 131.194f, 0.17905f},
                                        {2136.235f, 1347.894f, 131.628f, 0.20262f}, {2138.219f, 1356.240f, 132.169f, 5.95173f}, {2140.584f, 1351.624f, 132.142f, 6.08525f}}}},
        {// Market Row
            WORLDSTATE_WAVE_MARKER_MR, {{{2226.364f, 1331.808f, 127.0193f, 3.298672f}, {2229.934f, 1329.146f, 127.057f, 3.24605f}, {2225.028f, 1327.269f, 127.791f, 3.03792f},
                                           {2223.844f, 1335.282f, 127.749f, 3.47774f}, {2222.192f, 1330.859f, 127.526f, 3.18793f}, {2225.865f, 1331.029f, 127.007f, 3.18793f}}}},
        {// Festival Lane
            WORLDSTATE_WAVE_MARKER_FL, {{{2183.596f, 1238.823f, 136.551f, 2.16377f}, {2181.420f, 1237.357f, 136.565f, 2.16377f}, {2178.692f, 1237.446f, 136.694f, 1.99098f},
                                           {2184.980f, 1242.458f, 136.772f, 2.59181f}, {2176.873f, 1240.463f, 136.420f, 2.10094f}, {2181.523f, 1244.298f, 136.338f, 2.38997f}}}},
        {// Elders' Square
            WORLDSTATE_WAVE_MARKER_ES, {{{2267.003f, 1168.055f, 137.821f, 2.79050f}, {2264.392f, 1162.145f, 137.910f, 2.39937f}, {2262.785f, 1166.648f, 138.053f, 2.71353f},
                                           {2265.214f, 1170.771f, 137.972f, 2.80385f}, {2259.745f, 1159.360f, 138.198f, 2.34047f}, {2264.222f, 1171.708f, 138.047f, 2.82742f}}}},
        {// Town Hall
            WORLDSTATE_WAVE_MARKER_TH, {{{2351.656f, 1218.682f, 130.062f, 4.63383f}, {2354.921f, 1218.425f, 130.280f, 4.63383f}, {2347.516f, 1216.976f, 130.491f, 5.02496f},
                                           {2356.508f, 1216.656f, 130.445f, 4.29061f}, {2346.674f, 1216.739f, 130.576f, 5.32341f}, {2351.728f, 1214.561f, 130.255f, 4.61891f}}}}}};
  ...
  public:
    ...
    struct instance_culling_of_stratholme_InstanceMapScript : public InstanceScript
    {
        instance_culling_of_stratholme_InstanceMapScript(InstanceMap* map) : InstanceScript(map), _currentState(JUST_STARTED), _infiniteGuardianTimeout(0), _waveCount(0), _currentSpawnLoc(0)
        {
            ...
            _currentWorldStates[WORLDSTATE_SHOW_CRATES] = _currentWorldStates[WORLDSTATE_CRATES_REVEALED] = _currentWorldStates[WORLDSTATE_WAVE_COUNT] =
                _currentWorldStates[WORLDSTATE_TIME_GUARDIAN_SHOW] = _currentWorldStates[WORLDSTATE_TIME_GUARDIAN] = 0;
        ...
        void ReadSaveDataMore(std::istringstream& data) override
        {
            ...
            LOG_DEBUG("scripts.cos", "instance_culling_of_stratholme::ReadSaveDataMore: Loaded with state %u and guardian timeout at %zu minutes %zu seconds from now", (uint32)loadState,
                timediff / MINUTE, timediff % MINUTE);
        }
