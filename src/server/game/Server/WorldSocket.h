...
class FC_GAME_API WorldSocket : public Socket<WorldSocket> {
 ...
 private:
  ...
  void HandleAuthSessionCallback(
      std::shared_ptr<WorldPackets::Auth::AuthSession> authSession,
      PreparedQueryResult result);
  void HandleAuthContinuedSession(
  ...
  MPSCQueue<EncryptablePacket, &EncryptablePacket::SocketQueueLink>
      _bufferQueue;
