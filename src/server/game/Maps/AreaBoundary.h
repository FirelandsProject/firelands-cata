...
class FC_GAME_API AreaBoundary
{
    public:
...
class FC_GAME_API RectangleBoundary : public AreaBoundary
{
    public:
...
class FC_GAME_API CircleBoundary : public AreaBoundary
{
    public:
...
class FC_GAME_API EllipseBoundary : public AreaBoundary
{
    public:
...
class FC_GAME_API TriangleBoundary : public AreaBoundary
{
    public:
...
class FC_GAME_API ParallelogramBoundary : public AreaBoundary
{
    public:
...
class FC_GAME_API ZRangeBoundary : public AreaBoundary
{
    public:
...
class FC_GAME_API BoundaryUnionBoundary : public AreaBoundary
{
    public:
