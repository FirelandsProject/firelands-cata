...
FC_GAME_API extern uint32 const WintergraspFaction[];
...
class FC_GAME_API BattlefieldWG : public Battlefield
{
    public:
        ~BattlefieldWG();
        /**
...
struct FC_GAME_API BfWGGameObjectBuilding
{
private:
    // WG object
    BattlefieldWG* _wg;
...
struct FC_GAME_API WintergraspWorkshop
{
private:
