...
void WorldSession::HandleChannelPassword(WorldPacket& recvPacket)
{
    ...
    LOG_DEBUG("chat.system", "CMSG_CHAT_CHANNEL_PASSWORD %s Channel: %s, Password: %s",
...
void WorldSession::HandleChannelSetOwner(WorldPacket& recvPacket)
{
    ...
    LOG_DEBUG("chat.system", "CMSG_CHAT_CHANNEL_SET_OWNER %s Channel: %s, Target: %s",
...
void WorldSession::HandleChannelOwner(WorldPacket& recvPacket)
{
    ...
    LOG_DEBUG("chat.system", "CMSG_CHAT_CHANNEL_OWNER %s Channel: %s",
        GetPlayerInfo().c_str(), channelName.c_str());
...
void WorldSession::HandleChannelModerator(WorldPacket& recvPacket)
{
    ...
    LOG_DEBUG("chat.system", "CMSG_CHAT_CHANNEL_MODERATOR %s Channel: %s, Target: %s",
        GetPlayerInfo().c_str(), channelName.c_str(), targetName.c_str());
...
void WorldSession::HandleChannelUnmoderator(WorldPacket& recvPacket)
{
    ...
    LOG_DEBUG("chat.system", "CMSG_CHAT_CHANNEL_UNMODERATOR %s Channel: %s, Target: %s",
        GetPlayerInfo().c_str(), channelName.c_str(), targetName.c_str());
...
void WorldSession::HandleChannelMute(WorldPacket& recvPacket)
{
    ...
    LOG_DEBUG("chat.system", "CMSG_CHAT_CHANNEL_MUTE %s Channel: %s, Target: %s",
        GetPlayerInfo().c_str(), channelName.c_str(), targetName.c_str());
...
void WorldSession::HandleChannelUnmute(WorldPacket& recvPacket)
{
    ...
    LOG_DEBUG("chat.system", "CMSG_CHAT_CHANNEL_UNMUTE %s Channel: %s, Target: %s",
        GetPlayerInfo().c_str(), channelName.c_str(), targetName.c_str());
...
void WorldSession::HandleChannelInvite(WorldPacket& recvPacket)
{
    ...
    LOG_DEBUG("chat.system", "CMSG_CHAT_CHANNEL_INVITE %s Channel: %s, Target: %s",
        GetPlayerInfo().c_str(), channelName.c_str(), targetName.c_str());
...
void WorldSession::HandleChannelKick(WorldPacket& recvPacket)
{
    ...
    LOG_DEBUG("chat.system", "CMSG_CHAT_CHANNEL_KICK %s Channel: %s, Target: %s",
        GetPlayerInfo().c_str(), channelName.c_str(), targetName.c_str());
...
void WorldSession::HandleChannelBan(WorldPacket& recvPacket)
{
    ...
    LOG_DEBUG("chat.system", "CMSG_CHAT_CHANNEL_BAN %s Channel: %s, Target: %s",
        GetPlayerInfo().c_str(), channelName.c_str(), targetName.c_str());
...
void WorldSession::HandleChannelUnban(WorldPacket& recvPacket)
{
    ...
    LOG_DEBUG("chat.system", "CMSG_CHAT_CHANNEL_UNBAN %s Channel: %s, Target: %s",
        GetPlayerInfo().c_str(), channelName.c_str(), targetName.c_str());
...
void WorldSession::HandleChannelAnnouncements(WorldPacket& recvPacket)
{
    ...
    LOG_DEBUG("chat.system", "CMSG_CHAT_CHANNEL_ANNOUNCEMENTS %s Channel: %s",
        GetPlayerInfo().c_str(), channelName.c_str());
...
void WorldSession::HandleUnsetChannelWatch(WorldPacket& recvPacket)
{
    ...
    LOG_DEBUG("chat.system", "CMSG_UNSET_CHANNEL_WATCH %s Channel: %s",
        GetPlayerInfo().c_str(), channelName.c_str());
