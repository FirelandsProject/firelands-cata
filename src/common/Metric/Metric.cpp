...
template FC_COMMON_API std::string Metric::FormatInfluxDBValue(int8);
template FC_COMMON_API std::string Metric::FormatInfluxDBValue(uint8);
template FC_COMMON_API std::string Metric::FormatInfluxDBValue(int16);
template FC_COMMON_API std::string Metric::FormatInfluxDBValue(uint16);
template FC_COMMON_API std::string Metric::FormatInfluxDBValue(int32);
template FC_COMMON_API std::string Metric::FormatInfluxDBValue(uint32);
template FC_COMMON_API std::string Metric::FormatInfluxDBValue(int64);
template FC_COMMON_API std::string Metric::FormatInfluxDBValue(uint64);
