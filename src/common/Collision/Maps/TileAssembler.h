...
namespace VMAP
{
    ...
    */
    ...
    class FC_COMMON_API ModelPosition
    {
        private:
    ...
    struct FC_COMMON_API MapSpawns
    {
        MapSpawns() { }
    ...
    struct FC_COMMON_API GroupModel_Raw
    {
        uint32 mogpflags;
        uint32 GroupWMOID;
    ...
    struct FC_COMMON_API WorldModel_Raw
    {
        uint32 RootWMOID;
    ...
    class FC_COMMON_API TileAssembler
    {
        private:
            std::string iDestDir;
            std::string iSrcDir;
