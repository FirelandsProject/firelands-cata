...
#ifndef _Firelands_Hash_h__
#define _Firelands_Hash_h__
...
namespace std
{
    ...
    public:
        ...
        {
            size_t hashVal = 0;
            Firelands::hash_combine(hashVal, p.first);
            Firelands::hash_combine(hashVal, p.second);
            return hashVal;
        }
    };
}

#endif // _Firelands_Hash_h__
