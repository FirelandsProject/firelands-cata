...
namespace Firelands
{
    ...
    namespace Containers
    {
        ...
        {
            static_assert(std::is_base_of<std::forward_iterator_tag, typename std::iterator_traits<typename C::iterator>::iterator_category>::value, "Invalid container passed to Firelands::Containers::RandomResize");
        ...
        /**
         * @fn void Firelands::Containers::RandomShuffle(C& container)
         *
        ...
        /**
         * @fn bool Firelands::Containers::Intersects(Iterator first1, Iterator last1, Iterator first2, Iterator last2)
         *
        ...
        */
        ...
        /**
        * @fn bool Firelands::Containers::Intersects(Iterator first1, Iterator last1, Iterator first2, Iterator last2, Predicate&& equalPred)
        *
        * @brief Checks if two SORTED containers have a common element
        *
        * @param first1 Iterator pointing to start of the first container
