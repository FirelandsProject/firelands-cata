...
UPDATE `firelands_string` SET `entry`=1999 WHERE `entry`=1184; -- 1184 was already used on 4.3.4 but no on master, on master 1999 is used but it will never be used on 3.3.5a/4.3.4 so i reuse this

DELETE FROM `firelands_string` WHERE `entry`=1184;
