...
-- Update firelands strings for various cs_list strings, to support showing spawn ID and guid.
...
-- Add new firelands strings for extra npc/gobject info lines
DELETE FROM `firelands_string` WHERE `entry` BETWEEN 5070 AND 5082;
