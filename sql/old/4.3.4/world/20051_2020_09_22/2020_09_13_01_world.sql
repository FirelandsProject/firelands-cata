...
ALTER TABLE `firelands_string` CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
ALTER TABLE `firelands_string` CHANGE `content_default` `content_default` text NOT NULL;
ALTER TABLE `firelands_string` CHANGE `content_loc1` `content_loc1` text NULL;
ALTER TABLE `firelands_string` CHANGE `content_loc2` `content_loc2` text NULL;
ALTER TABLE `firelands_string` CHANGE `content_loc3` `content_loc3` text NULL;
ALTER TABLE `firelands_string` CHANGE `content_loc4` `content_loc4` text NULL;
ALTER TABLE `firelands_string` CHANGE `content_loc5` `content_loc5` text NULL;
ALTER TABLE `firelands_string` CHANGE `content_loc6` `content_loc6` text NULL;
ALTER TABLE `firelands_string` CHANGE `content_loc7` `content_loc7` text NULL;
ALTER TABLE `firelands_string` CHANGE `content_loc8` `content_loc8` text NULL;
