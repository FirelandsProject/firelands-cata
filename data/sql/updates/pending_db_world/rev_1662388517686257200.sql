DELETE FROM `creature_template_movement` WHERE `CreatureId` IN (38038, 44794, 48304);
...
UPDATE `creature_template` SET `mechanic_immune_mask`=`mechanic_immune_mask`|32, `flags_extra`=`flags_extra`|262144, `AIName`='SmartAI', `ScriptName`='' WHERE `entry` IN (38038, 44794, 48304);

DELETE FROM `smart_scripts` WHERE `entryorguid` IN (38038, 44794, 48304) AND `source_type`=0;
