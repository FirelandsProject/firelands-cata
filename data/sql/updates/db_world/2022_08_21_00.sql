DELETE FROM `creature_trainer` WHERE `CreatureId` IN (37115, 37121, 42331, 42323, 42366, 43006, 43455, 15279, 15284, 15280, 39214, 42618, 15285, 38244, 15513, 15283);
...
DELETE FROM `gossip_menu_option` WHERE  `MenuId` IN ( 11620, 10878, 10879, 11617, 11621, 11810, 11831, 11185, 14136, 14139, 14137, 11645, 14140, 10985, 14141, 14138);
