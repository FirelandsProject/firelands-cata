UPDATE `creature_template` SET `ScriptName`='npc_bilgewater_bucaneer', `NpcFlag`=`NpcFlag`|1 WHERE `entry` IN (37179, 37213);
UPDATE `creature_template` SET `unit_flags`=`unit_flags`|33587968 WHERE `entry`=48572;
...
(48572, 0, 0, 0, 50331648, 131584, 0, 0, 0, 0, 5, NULL);
