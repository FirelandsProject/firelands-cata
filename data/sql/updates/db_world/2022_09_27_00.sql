...
DELETE FROM `command` WHERE `name` IN ('anticheat', 'anticheat delete', 'anticheat global', 'anticheat handle', 'anticheat jail', 'anticheat parole', 'anticheat player', 'anticheat purge');
