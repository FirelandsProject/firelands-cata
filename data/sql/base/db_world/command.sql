...
INSERT INTO `command` (`name`, `permission`, `help`) VALUES
	...
	('reload config', 630, 'Syntax: .reload config\r\n\r\nReload config settings (by default stored in firelands.conf). Not all settings can be change at reload: some new setting values will be ignored until restart, some values will applied with delay or only to new objects/maps, some values will explicitly rejected to change at reload.'),
	...
	('reload creature_onkill_reward', 635, 'Syntax: .reload creature_onkill_reward \nReload creature_onkill_reward table.'),
	...
	('reload firelands_string', 704, 'Syntax: .reload firelands_string\nReload firelands_string table.'),
	...
	('server exit', 720, 'Syntax: .server exit\r\n\r\nTerminate firelands-core NOW. Exit code 0.'),
	...
	('whispers', 471, 'Syntax: .whispers on|off\r\nEnable/disable accepting whispers by GM from players. By default use firelandsd.conf setting.'),
